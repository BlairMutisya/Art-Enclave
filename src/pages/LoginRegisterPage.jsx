...
const LoginRegisterPage = () => {
    ...
    const handleSignUp = async () => {
        try {
            await Axios.post("https://json-server-template-s4mp.onrender.com/user-data", signUpData);
    ...
    const handleLogin = async () => {
        try {
            await Axios.post("https://json-server-template-s4mp.onrender.com/user-data", loginData);
